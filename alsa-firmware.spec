...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1603479610
...
cp %{_builddir}/alsa-firmware-1.2.4/COPYING %{buildroot}/usr/share/package-licenses/alsa-firmware/9db6e6f4189b7101178eef598c9985910e51456d
cp %{_builddir}/alsa-firmware-1.2.4/aica/license.txt %{buildroot}/usr/share/package-licenses/alsa-firmware/f1ed3062fa64763c2e60ce4cd36a39117d44ee3c
cp %{_builddir}/alsa-firmware-1.2.4/echoaudio/license.txt %{buildroot}/usr/share/package-licenses/alsa-firmware/e16db4bd79d477e0f004bab97ed4de580acf476e
%make_install
